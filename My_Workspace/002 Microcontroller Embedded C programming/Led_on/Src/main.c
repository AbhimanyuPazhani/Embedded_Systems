...
//The RCC starting address is : 0x40023800
...
//	*pClkctrlreg = temp; //write back
	*pClkctrlreg = *pClkctrlreg |0x02;  //page no: 161 for port B

	//2. configure the mode of the IO pin as output  //pag no 205 0x ffff3fff
	// a. Clear the 14th and 15th pin position (C:EAR)
	*pPortBModeReg &= 0xFFFF3FFF;
	...
	*pPortBModeReg |= 0x00004000;
	 ...
	 *pPortBOutReg |= 0x80;   // LED ON  -- 0x0080
